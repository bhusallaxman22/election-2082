...
export const provinces: ProvinceData[] = [
  {
    ...
    districts: [
      ...
      { slug: "panchthar", name: "Panchthar", constituencies: 2, districtId: 2 },
      ...
      { slug: "sunsari", name: "Sunsari", constituencies: 3, districtId: 10 },
  ...
  },
  {
    ...
    partyResults: [],
    districts: [
      { slug: "saptari", name: "Saptari", constituencies: 3, districtId: 15 },
      ...
      { slug: "parsa", name: "Parsa", constituencies: 5, districtId: 34 },
    ],
  },
  {
    id: 3,
  ...
  },
  {
    ...
    districts: [
      ...
      { slug: "rupandehi", name: "Rupandehi", constituencies: 6, districtId: 46 },
      { slug: "kapilvastu", name: "Kapilvastu", constituencies: 4, districtId: 47 },
      { slug: "palpa", name: "Palpa", constituencies: 1, districtId: 43 },
      { slug: "arghakhanchi", name: "Arghakhanchi", constituencies: 1, districtId: 44 },
      { slug: "gulmi", name: "Gulmi", constituencies: 1, districtId: 42 },
  ...
  },
  {
    ...
    districts: [
      ...
      { slug: "bajhang", name: "Bajhang", constituencies: 2, districtId: 69 },
      { slug: "darchula", name: "Darchula", constituencies: 1, districtId: 72 },
      { slug: "baitadi", name: "Baitadi", constituencies: 2, districtId: 73 },
      ...
      { slug: "kailali", name: "Kailali", constituencies: 4, districtId: 71 },
      { slug: "kanchanpur", name: "Kanchanpur", constituencies: 2, districtId: 75 },
    ],
  },
];
